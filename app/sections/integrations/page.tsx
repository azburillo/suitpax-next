    ...
    <div className="relative overflow-hidden bg-black text-white min-h-screen">
      ...
      <div className="relative z-10 container mx-auto px-4 py-16 sm:px-6 sm:py-24 lg:px-8">
        <div className="text-center mb-20">
          <GradientText className="text-4xl font-extrabold tracking-tight sm:text-5xl lg:text-6xl mb-4">
        ...
        <div className="mt-12 mb-20">
          <AnalyticsCard
            ...
            description="Track the performance and usage of your integrated tools to optimize your workflow."
            pageViews="37.36K"
